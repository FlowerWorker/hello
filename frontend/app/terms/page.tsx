    ...
    <div className={styles.pageContainer}>
      ...
      <div className={styles.termsContainer}>
        ...
        <div className={styles.section}>
          ...
          <ul>
            <li>Account Creation</li>
              <span className= {styles.innertext}>You must provide accurate, complete, and current information during registration.You are responsible for maintaining the confidentiality of your account credentials.</span>
        ...
        <div className={styles.section}>
          ...
          <ul>
            <li>APosting false or misleading information.</li>
        ...
        <div className={styles.section}>
          ...
          <ul>
            <li>For Employers and Recruiters</li>
              <span className= {styles.innertext}>Employers and recruiters are solely responsible for the accuracy of job postings and recruitment activities.FlowerWorker does not guarantee the suitability of candidates or the success of hiring processes.</span>
        ...
        <div className={styles.section}>
          ...
          <ul>
            <li>Payment Processing</li>
              <span className= {styles.innertext}>All payments are processed securely through our third-party payment providers.You are responsible for ensuring accurate payment information</span>
        ...
        <div className={styles.section}>
          ...
          <ul>
            <li>Platform Content</li>
              <span className= {styles.innertext}>All content on the platform, including logos, text, graphics, and software, is the property of FlowerWorker or its licensors.You may not copy, modify, distribute, or reproduce platform content without our explicit consent.</span>
            <li>User Content</li>
        ...
        <div className={styles.Disclaimersection}>
           <div className={styles.boxsection}>
            ...
            <p>To the fullest extent permitted by law, FlowerWorker is not liable for:Indirect, incidental, or consequential damages.Loss of data, employment opportunities, or revenue.</p><p>Errors, interruptions, or failures of the platform.</p>
           </div>
           <div className={styles.boxsection}>
            <h2>Disclaimers</h2>
