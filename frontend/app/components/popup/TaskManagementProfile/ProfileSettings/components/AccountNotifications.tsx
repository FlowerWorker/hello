const notificationCheckboksList = [
    ...
    <div className="p-6 bg-white shadow-md rounded-md max-w-lg mx-auto">
      ...
      <div className="mb-6">
        ...
        <ul className="space-y-3">
          {notificationCheckboksList.map((item) => (
            <li key={item.id}>
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600 mb-4">
          You`ll only receive notifications in the hours you choose. Outside of
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="flex items-center space-x-3">
              <select className="border border-black form-select block w-full mt-1 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-300">
          ...
          <div>
            <p className="font-medium mb-2">When I`m not active on desktop...</p>
