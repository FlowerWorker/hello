...
import PrioritySelector from "./SelectPriority"; // Import your PrioritySelector component
// Icon imports
        ...
        >
            ...
            <div className="flex flex-col text-[#827E79] text-sm font-semibold gap-1 transition-all duration-300">
                ...
                {!isCollapsed && (
                    ...
                    <button className="flex items-center hover:bg-[#dddcdb] hover:rounded-lg py-1 px-2 max-w-[200px]" onClick={() => setIsPriorityVisible(true)}>
