...
export default function AddTaskCard({ listName }: AddTaskCardProps) {
  ...
  // Toggle AddLabels visibility
  const toggleLabelManager = () => {
    setShowLabelManager((prev) => !prev);
  };

  // Open the "Create a label" modal directly
  ...
  <div className="flex flex-row gap-x-2 mb-2">
    {selectedLabels.map((labelName, index) => {
      ...
      <div className="relative">
        {/* Show AddLabels component when toggled */}
        {showLabelManager && (
          <div className="absolute bottom-[100px] -right-[350px] z-30 w-[330px]">
            <AddLabels
